...
class SurfDatabaseServiceEventListener
{
public:
...
public:
	static bool RegisterEventListener(SurfDatabaseServiceEventListener *eventListener);
	static bool UnregisterEventListener(SurfDatabaseServiceEventListener *eventListener);
...
private:
	static Surf::Database::DatabaseType databaseType;
	static ISQLConnection *databaseConnection;

	static i32 currentMapID;

private:
	static CUtlVector<SurfDatabaseServiceEventListener *> eventListeners;

public:
	static Surf::Database::DatabaseType GetDatabaseType()
	{
		return databaseType;
	}
...
public:
	...
	static void SetupCourses(CUtlVector<SurfCourseDescriptor *> &courses);
