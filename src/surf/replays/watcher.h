...
struct ReplayFilterCriteria
{
	...
	// Used by run replays. Current mode by default.
...
public:
	static void PrintUsage(SurfPlayer *player);

	void FilterAndPrintMatchingCheaterReplays(ReplayFilterCriteria &criteria, SurfPlayer *player);
	void FilterAndPrintMatchingRunReplays(ReplayFilterCriteria &criteria, SurfPlayer *player);
	void FilterAndPrintMatchingManualReplays(ReplayFilterCriteria &criteria, SurfPlayer *player);

	void FindReplaysMatchingCriteria(const char *inputs, SurfPlayer *player);
