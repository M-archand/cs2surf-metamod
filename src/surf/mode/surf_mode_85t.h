...
class Surf85tModePlugin : public ISmmPlugin, public IMetamodListener
{
public:
...
public:
	...
	const char *GetName()
	{
		return "CS2Surf-Mode-85tick";
	}

	const char *GetDescription()
	{
		return "85tick mode plugin for CS2Surf";
	}
...
class Surf85tModeService : public SurfModeService
{
