...
class Surf102tModePlugin : public ISmmPlugin, public IMetamodListener
{
public:
...
public:
	...
	const char *GetName()
	{
		return "CS2Surf-Mode-102tick";
	}

	const char *GetDescription()
	{
		return "102tick mode plugin for CS2Surf";
	}
...
class Surf102tModeService : public SurfModeService
{
	...
	static inline CVValue_t modeCvarValues[] = {
		...
		(float)43.55f,   // sv_air_max_wishspeed
